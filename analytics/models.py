...
class ExchangeRecord(models.Model):
    ...
    macd = models.JSONField(blank=False, null=False)
    fibonacciretracement = models.JSONField(blank=False, null=False)
    bollinger = models.JSONField(blank=False, null=False)
    rsi = models.JSONField(blank=False, null=False)
    stochrsi = models.JSONField(blank=False, null=False)
    atr = models.JSONField(blank=False, null=False)
